...
const TRACKING_PURPOSE =
  'This lets CapFlow show ads that are more relevant to you. Your videos are never uploaded, your data is never sold, and the app works exactly the same either way.';
...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...config,
    name: config.name ?? 'CapFlow',
    slug: config.slug ?? 'capflow',
    plugins: [
